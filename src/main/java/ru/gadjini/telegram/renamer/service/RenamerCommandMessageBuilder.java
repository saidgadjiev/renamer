...
public class RenamerCommandMessageBuilder implements CommandMessageBuilder {
    ...
    public String getCommandsInfo(Locale locale) {
        ...
        info.append("/").append(CommandNames.DEL_THUMBNAIL_COMMAND).append(" - ").append(localisationService.getMessage(MessagesProperties.DEL_THUMB_COMMAND_DESCRIPTION, locale)).append("\n");
